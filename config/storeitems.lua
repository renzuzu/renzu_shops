return {
	General = { -- General Stores 24/7
		...
		{ lvl = 1, name = 'sanmig', price = 50 , category = 'beverages'},
		...
		{ lvl = 2, name = 'marlboro_blue_pack', price = 100 , category = 'tobacco'},
		...
		{ lvl = 2, name = 'doublebartburger', price = 200 , category = 'food'},
